function fetchOpportunityApprovals_oGX() {
  var graphQLQuery = `
      query AllOpportunityApplication {
        allOpportunityApplication(
            filters: {
                date_approved: { from: "2024-02-01T00:00:00Z", to: "2024-12-15T00:00:00Z" }
                person_committee: lc_id
                programmes: [7, 8, 9]
                statuses: ["approved", "realized", "finished","completed"]
            }
  ...
  sheet.getRange("B7:O").clearContent();
  ...
  var data = applicationData.map(function (application) {
    ...
    return [
      ...
      application.slot.start_date,
      application.slot.end_date,
      programme,
